...
$LANG_GUS_admin = array(
    ...
    'instructions'  => 'Geeklog訪問者統計[GUS]プラグインは、サイトの訪問者、使用ブラウザー、オペレーティングシステム(OS)、閲覧ページ、直前に訪問したページ(リファラー)に関する統計情報を収集します。このプラグインを利用することで、管理者は表形式でデータを見ることができます。',
